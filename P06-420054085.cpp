...
// average normals
	GLfloat cubo_vertices[] = {
		...
		0.5f, -0.5f,  -0.5f,	0.98f,	0.51f,		-1.0f,	0.0f,	0.0f,
		0.5f,  0.5f,  -0.5f,	0.98f,	0.74f,		-1.0f,	0.0f,	0.0f,
		...
		// left // miedo
		//x		y		z		S		T
		-0.5f, -0.5f,  -0.5f,	0.02f,  0.51f,		1.0f,	0.0f,	0.0f,
		-0.5f, -0.5f,  0.5f,	0.31f,	0.51f,		1.0f,	0.0f,	0.0f,
		-0.5f,  0.5f,  0.5f,	0.31f,	0.74f,		1.0f,	0.0f,	0.0f,
		-0.5f,  0.5f,  -0.5f,	0.02f,	0.74f,		1.0f,	0.0f,	0.0f,

		// bottom // enojo
		//x		y		z		S		T
		-0.5f, -0.5f,  0.5f,	0.34f,  0.49f,		0.0f,	1.0f,	0.0f,
		 0.5f,  -0.5f,  0.5f,	0.65f,	0.49f,		0.0f,	1.0f,	0.0f,
		 0.5f,  -0.5f,  -0.5f,	0.65f,	0.27f,		0.0f,	1.0f,	0.0f,
		-0.5f, -0.5f,  -0.5f,	0.34f,	0.27f,		0.0f,	1.0f,	0.0f,

		//UP // desagrado
		 //x		y		z		S		T
		 -0.5f, 0.5f,  0.5f,	0.35f,  0.76f,		0.0f,	-1.0f,	0.0f,
		  0.5f,  0.5f,  0.5f,	0.66f,	0.76f,		0.0f,	-1.0f,	0.0f,
		  0.5f, 0.5f,  -0.5f,	0.66f,	0.99f,		0.0f,	-1.0f,	0.0f,
...
int main()
{
	...
	dadoTexture = Texture("Textures/dado_emociones.jpg");
